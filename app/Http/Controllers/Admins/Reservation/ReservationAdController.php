...
namespace App\Http\Controllers\Admins\Reservation;
...
class ReservationAdController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('admins.reservation.show', compact('reservation', 'users'));
    }
    ...
    public function create()
    {
        ...
        return view('admins.reservation.create', compact('voitures'));
    }

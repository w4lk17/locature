    ...
    <div class="hero bg-black-75 overflow-hidden">
        <div class="hero-inner">
            <div class="content content-full text-center">
                ...
                <h1 class="display-4 font-w600 mb-3 text-white invisible" data-toggle="appear"
                    data-class="animated fadeInDown">
                    LOCATURE
                    <hr> <span class="font-w300"></span>
                </h1>
                ...
                <div class="col-lg-4 invisible" data-toggle="appear">
                    ...
                    <div class="block block-rounded block-fx-pop">
                        <div class="block-content block-content-full">
                            ...
                            <p class="font-size-sm text-muted text-left">
                                Vous pouvez annuler ou modifier la plupart des réservations gratuitement jusqu’à 48
                ...
                <div class="col-lg-4 invisible" data-toggle="appear">
                    ...
                    <div class="block block-rounded block-fx-pop">
                        <div class="block-content block-content-full">
                            ...
                            <p class="font-size-sm text-muted text-left">
                                It features a clean Laravel installation with all OneUI assets ready to work with
                                Laravel Mix and a few example pages to get you started.
                            </p>
                        </div>
                    </div>
        ...
        <div class="content content-full">
            <div class="py-5">
                ...
                <h3 class="font-w400 text-white-50 mb-5 text-center">
                    Découvrez ce que nos clients ont écrit sur locature, <br> la meilleure agence de reservation de
                    voiture en ligne.
                </h3>
                <div class="row items-push-2x">
                    <div class="col-md-4 invisible" data-toggle="appear">
                        ...
                        <div class="font-size-h5 text-white-50 mb-2">A combination of flexibility and ease of uses. The
                            design is beautiful, but I really value the ease in which I was able to integrate this into
                            my development workflow and platform.</div>
                    ...
                    <div class="col-md-4 invisible" data-toggle="appear" data-timeout="150">
                        ...
                        <div class="font-size-h5 text-white-50 mb-2">While reading the docs i can feel that you
                            literally gave your heart to create this project. It is a high quality piece of work, thanks
                            for sharing it!</div>
                    ...
                    <div class="col-md-4 invisible" data-toggle="appear" data-timeout="300">
                        ...
                        <div class="font-size-h5 text-white-50 mb-2">This is my first purchase on Themeforest and I am
                            delighted. Everything from the design to the code is beautifully crafted and the customer
                            support is great also. Congratulations pixelcave.</div>
...
<div id="one-call-to-action" class="bg-light">
    <div class="content content-full">
        <div class="py-3 py-md-6 text-center">
            ...
            <h3 class="font-w400 text-muted mb-4 invisible" data-toggle="appear" data-class="animated fadeInDown"
                data-timeout="300">

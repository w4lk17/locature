...
{{--            </button>--}}
        ...
        <div class="d-flex align-items-center">
            ...
            <div id="notif" class="dropdown d-inline-block ml-2">
                            ...
                            <li>
                                <a class="text-dark media py-2" href="javascript:void(0)">
                                    ...
                                    <div class="media-body pr-2">
                                        <div class="font-w600">
                                            Nouvelle reservation,N*{{ $notifications->data['reservation'] }} </br>
                                            de {{ $notifications->data['name'] }}
                                        </div>
                                        <small
                                            class="text-muted">{{ $notifications->created_at->diffForHumans() }}</small>
                                    </div>
                                </a>
                            </li>
                        @empty

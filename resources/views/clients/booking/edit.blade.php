            ...
            <div class="container">
                    <div class="card-header">
                        ...
                        <h3>
                            ...
                            <span class="">Imatriculation : <small class=" text-uppercase">{{ $voiture_info->matricule }}</small></span>
                            <span class="">Prix : <small class=" text-uppercase">{{ $voiture_info->prix }}</small></span>
                        </h3>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="{{ route('bookings.update', $reservation->id) }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        ...
                                        <select class="js-select2 form-control" id="val-select2" name="voitureId" style="width: 100%;" data-placeholder="{{ $voiture_info->marque }} {{ $voiture_info->modele }}">
                            ...
                            <div class="row ">
                                ...
                                <div class="col-sm-5">
                                    <a href="javascript:history.back()" class="btn btn-sm btn-outline-primary"> Annuler</a>
                                </div>

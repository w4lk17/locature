            ...
            <div class="block-content block-content-full">
               <!-- <div class="row">
                ...
                <p class="font-w700">Statut : <span class="{{ $reservation->etat == 0
                    ...
                    :  ($reservation->etat == 1
                    ? 'badge badge-info'
                    : 'badge badge-danger')}} font-w700 font-size-sm"> {{ $reservation->etat == 0 ?'En attente...' :($reservation->etat == 1 ?'Acceptée' :'Rejetée')}}</span>
                    @if( $reservation->etat !== 0 && $reservation->etat !== 1 )

                    <button type="button" class="btn btn-block-options" data-toggle="popover"
                                data-placement="right" title=""
                                data-content="Veillez contacter la Direction pour plus d'information.">
                ...
                <p class="font-w700">Reservée le : <span class="font-w700 font-size-md">{{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $reservation->created_at)->format('j/m/Y H:i:s') }}</span></p>
                <div>

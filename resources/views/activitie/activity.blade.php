                            ...
                            @forelse ($notifications as $notification)
                                <li>
                                    <div class="activity-user">
                                        <a href="javascript:void(0)" title="Lesley Grauer" class="avatar">
                                            <img class="avatar" src="{{ asset('assets/media/avatars/avatar13.jpg') }}"
                                                 alt="">
                                        </a>
                                    </div>
                                    <div class="activity-content">
                                        <div class="timeline-content font-w600" role="alert">
                                            ...
                                            L'utilisateur <a href="javascript:void(0)"
                                                             class="name">{{ $notification->data['name'] }}</a>

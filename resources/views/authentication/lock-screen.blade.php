                                    ...
                                    <div class="block block-themed mb-0">
                                        <div class="block-header bg-danger">
                                            ...
                                            <form action="/logout" method="post" id="logout_form">
                                                {{ csrf_field() }}
                                                <a class="btn-block-option" href="#" data-toggle="tooltip" data-placement="left" title="Se connecter avec un autre compte" onclick="document.getElementById('logout_form').submit()">
                                        ...
                                        <div class="block-content">
                                            <div class="p-sm-3 px-lg-4 py-lg-5 text-center">
                                                ...
                                                @endif
                                                <img class="img-avatar img-avatar96" src="{{ asset('assets/media/avatars/avatar10.jpg') }}" alt="">
                                                ...
                                                <form class="js-validation-lock" action="/account/lock" method="POST">
                                                    ...
                                                    <div class="form-group py-3">
                                                        <input type="password" id="lock-password" class="form-control form-control-lg form-control-alt "  name="password" placeholder="Mot de passe..">

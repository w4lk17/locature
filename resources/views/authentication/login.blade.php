                                ...
                                <div class="p-sm-3 px-lg-4 py-lg-5">
                                    ...
                                    <form class="js-validation-signin" action="/login" method="POST">
                                        ...
                                        <div class="py-3">
                                            ...
                                            <div class="form-group">
                                                <input type="password" class="form-control form-control-alt form-control-lg" id="login-password" name="password" placeholder="Mot de passe">
                                            </div>
                                            <div class="form-group">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="login-remember" name="remember_me">
                                                    <label class="custom-control-label font-w400" for="login-remember">Souviens-toi de moi</label>
                                                </div>
                                            </div>
                                        </div>
